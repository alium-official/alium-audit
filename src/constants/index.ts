...
export const TESTALM = new Token(ChainId.BSCTESTNET, '0xf671C33452adfB8e0f645d95d8E3C6Df0d78fED2', 18, 'ALM', 'Alium Token');
export const TESTWBNB = new Token(ChainId.BSCTESTNET, '0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd', 18, 'WBNB', 'Wrapped BNB');
export const TESTXXX1 = new Token(ChainId.BSCTESTNET, '0xB42A8e21f983A56d1e8D1b8f83CE51A9Eb0241FC', 18, 'XXX1', 'XXX1 Test');
export const TESTUSDT = new Token(ChainId.BSCTESTNET, '0x1138ebb3101f557b28326a28b6f192c7fecc95f7', 18, 'USDT', 'USDT Test');
